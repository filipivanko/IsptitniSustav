 ...
 * @author Filip
 */
public class ObrisiGrupuPitanjaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(grupaPitanja!=null){
        repo.obrisiGrupuPitanja(grupaPitanja);
        request.getSession().setAttribute("odabranaGrupaPitanja",null);
        }
