...
public class PoveziIspitIGrupuPitanjaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (grupaPitanja!=null && ispit!=null) {
            ...
            if (!grupaPitanja.provjeriDaLiJePovezanIspit(ispit)) {
                 grupaPitanja.getIspitiKojiSadrzeGrupuPitanja().add(ispit);
                
            }
            if (!ispit.provjeriDaLiJePovezanaGrupaPitanja(grupaPitanja)) {
                 ispit.getGrupePitanjaUIspitu().add(grupaPitanja);
            }
           repo.otvoriSession();
