...
public class ObrisiKorisnikaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Korisnik odabraniKorisnk = (Korisnik) request.getSession().getAttribute("odabraniKorisnk");
        if (odabraniKorisnk != null) {
            repo.obrisiKorisnika(odabraniKorisnk);
            request.getSession().setAttribute("odabraniKorisnk", null);
        }
