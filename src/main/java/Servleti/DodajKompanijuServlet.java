...
public class DodajKompanijuServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String naziv =request.getParameter("nazivNoveKompanije");
        String sjediste = request.getParameter("sjedisteNoveKompanije");
        String oib=  request.getParameter("oibNoveKompanije");
        ...
        request.getSession().setAttribute("odabranaKompanija", kompanija);
