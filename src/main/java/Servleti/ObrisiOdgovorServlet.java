...
public class ObrisiOdgovorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Odgovor odgovor = (Odgovor) request.getSession().getAttribute("odabraniOdgovor");
        if(odgovor!=null){
        repo.obrisiOdgovor(odgovor);
        request.getSession().setAttribute("odabraniOdgovor",null);
        }
