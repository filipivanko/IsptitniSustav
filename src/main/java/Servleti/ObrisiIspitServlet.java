...
public class ObrisiIspitServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Ispit odabraniIspit = (Ispit) request.getSession().getAttribute("odabraniIspit");
        if (odabraniIspit != null) {
            repo.obrisiIspit(odabraniIspit);
            request.getSession().setAttribute("odabraniIspit", null);
        }
