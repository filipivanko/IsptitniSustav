...
public class PrijavaServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		PrijavaKorisnikaUSustav prijava = new PrijavaKorisnikaUSustav();
		prijava.prijaviKorisnikaUSustav(request, response, repo);
	...
	private void napuniBazu() {
		...
		Korisnik korisnik = new Korisnik("ime", "prezime", "adresa", "strucnaSprema", "zanimanje", "oib", "korisnik",
				"korisnik", kompanija);
